...
class GetCategoryNews {
    ...
    static func getCategoryNews(category : String) -> [BreakingNews] {
        ...
        var request = URLRequest(url: URL(string: "https://newsapi.org/v2/top-headlines?country=tr&category=\(category)&apiKey=\(Constant.APIKEY)")!,timeoutInterval: Double.infinity)
