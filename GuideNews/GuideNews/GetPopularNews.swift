...
class getPopularNewsResponse {
    ...
    static func getPopularNews() -> [BreakingNews] {
        ...
        var request = URLRequest(url: URL(string: "https://newsapi.org/v2/top-headlines?country=us&apiKey=5af8c3269821473ba6b9dec29e62c4f2")!,timeoutInterval: Double.infinity)
